...
export function createDelegateTeamTool(input: {
  ...
  return createTool({
    ...
    description: [
      ...
      'Query example: {"team":"query","request":{"businessQuestion":"Which accounts do I have?","coverage":["account list"],"desiredGrain":["account"]}}. Query request is flat with no intent and no nested request.',
      'Account-creation example: {"team":"accounting","request":{"intent":"chart_of_accounts","request":{"action":"create_account","instruction":"preserve the complete user request","known":{"accountName":"Savings","accountingClass":"asset","normalBalance":"debit","nativeCurrency":"USD","purpose":"household savings"}}}}.',
      'Cash-flow example: {"team":"cash-flow","request":{"intent":"analysis","request":{"objective":"analyze August cash flow","analysisMode":"single","timeframe":{"start":"2026-08-01","end":"2026-08-31"}}}}.',
      'Investments-retirement education uses intent investment_education or retirement_education and nested request.question.',
      'Records-reporting facts use intent records_facts and nested request.focus.',
