...
export type ErrorCategoryV1 = z.infer<typeof ErrorCategorySchemaV1>;
...
export type RetryDirectiveV1 = z.infer<typeof RetryDirectiveSchemaV1>;
...
export interface PlusOneErrorInput {
...
export class PlusOneError extends Error {
  readonly category: ErrorCategoryV1;
  readonly code: string;
  readonly retry: RetryDirectiveV1;
  readonly receiptLookupRequired: boolean;
  readonly details: ErrorDetails;

  constructor(input: PlusOneErrorInput) {
